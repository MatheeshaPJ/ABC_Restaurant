    ...
    return (
        <div className='fixed top-0 left-0 w-full bg-black bg-opacity-70 text-white z-10'>
            <div className='flex justify-between items-center h-20 max-w-[1240px] mx-auto px-4'>
                <h1 className='w-full text-3xl font-bold text-[#d9b534] m-4 cursor-pointer'>ABC Restaurant</h1>
                ...
                <Link className='bg-[#d9b534] w-[200px] rounded-md  font-bold my-4 mx-4 py-3 text-center text-black hover:scale-105 duration-300' to="/signin">Sign-in</Link>
