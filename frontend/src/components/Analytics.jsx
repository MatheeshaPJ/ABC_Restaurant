    ...
    return (
        <div className='w-full bg-white py-16 px-4'>
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
                <img className='w-[500px] mx-auto my-4' src={burger} alt="burger.png" />
                <div className='flex flex-col justify-center'>
                    <p className='text-[#00df9a] font-bold'> HUNGRY BURGER</p>
                    ...
                    <button className='bg-black text-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3'>Order Now</button>
                </div>
