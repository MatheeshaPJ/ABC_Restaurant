...
const ManageMenu = () => {
   ...
   return (
    ...
    <div className="container mx-auto p-4 bg-white h-screen">
      ...
      <div className=''>
        <Link className='outline outline-[#f09c20]  text-[#f09c20]  hover:bg-[#f09c20] hover:text-white hover:outline-none py-2 px-4 rounded mr-2  ' to="/admin/addmenu"  >Add NewUser</Link>  
      </div>
